        ...
        module System {
            ...
            */
            class TcHmiControl extends TcHmi.Controls.System.baseTcHmiControl {
                ...
                protected __resourcesDomEventRegWatchOnMouseRightClick: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnMouseDoubleClick: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnMouseEnter: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnMouseMove: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnMouseOut: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnMouseLeave: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnMouseDown: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnMouseUp: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnMouseOver: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnMouseClick: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnMouseWheel: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnTouchStart: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnTouchMove: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnTouchEnd: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesDomEventRegWatchOnTouchCancel: Dictionary<{
                    event: EventProvider.IEventEntry;
                    domEventListener: TcHmiControl.IDomEventObj;
                }>;
                protected __resourcesEventRegWatchOnPressed: Dictionary<{
                    event: EventProvider.IEventEntry;
                    destroy: DestroyFunction;
                }>;
                protected __resourcesEventRegWatchOnMouseDownLeft: Dictionary<{
                    event: EventProvider.IEventEntry;
                    destroy: DestroyFunction;
                }>;
                protected __resourcesEventRegWatchOnMouseDownRight: Dictionary<{
                    event: EventProvider.IEventEntry;
                    destroy: DestroyFunction;
                }>;
                protected __resourcesEventRegWatchOnMouseUpLeft: Dictionary<{
                    event: EventProvider.IEventEntry;
                    destroy: DestroyFunction;
                }>;
                protected __resourcesEventRegWatchOnMouseUpRight: Dictionary<{
                    event: EventProvider.IEventEntry;
                    destroy: DestroyFunction;
                }>;
                ...
                /**
                 * Watches for registrations to events and handles them.
                 */
                protected __resumeEvents(): void;
                /**
                * Stops watching for registrations to events and stops handling of registered events.
                */
                protected __suspendEvents(): void;
                /**
                 * Version
                 * @preserve (Part of the public API)
                 */
                ...
                */
                ...
                /**
                 * Internal onject to store the values of the various background attributes.
                 */
                ...
                */
                 ...
                 * @preserve (Part of the public API)
                 */
                protected getAttributeDefaultValueInternal<T>(propertyName: string): T | null;
                /**
                 * Is raised if the mouseover event is raised from the ".tchmi-button-action-area" element.
                 * @param event
                 */
                protected __onElementMouseOver(event: EventProvider.IEventEntry): (e: MouseEvent) => void;
                /**
                 * Is raised if the mouseenter event is raised from the ".tchmi-button-action-area" element.
                 * @param event
                 */
                protected __onElementMouseEnter(event: EventProvider.IEventEntry): (e: MouseEvent) => void;
                /**
                * Is raised if the mousedown event is raised from the ".tchmi-button-action-area" element.
                * @param event
                */
                protected __onElementMouseDown(event: EventProvider.IEventEntry): (e: MouseEvent) => void;
                /**
                * Is raised if the MouseMove event is raised from the ".tchmi-button-action-area" element.
                * @param event
                */
                protected __onElementMouseMove(event: EventProvider.IEventEntry): (e: MouseEvent) => void;
                /**
                * Is raised if the mouseup event is raised from the ".tchmi-button-action-area" element.
                * @param event
                */
                protected __onElementMouseUp(event: EventProvider.IEventEntry): (e: MouseEvent) => void;
                /**
                * Is raised if the click event is raised from the ".tchmi-button-action-area" element.
                * @param event
                */
                protected __onElementMouseClick(event: EventProvider.IEventEntry): (e: MouseEvent) => void;
                /**
                * Is raised if the rightclick event is raised from the ".tchmi-button-action-area" element.
                * @param event
                */
                protected __onElementMouseRightClick(event: EventProvider.IEventEntry): (e: MouseEvent) => void;
                /**
                * Is raised if the doubleclick event is raised from the ".tchmi-button-action-area" element.
                * @param event
                */
                protected __onElementMouseDoubleClick(event: EventProvider.IEventEntry): (e: MouseEvent) => void;
                /**
                * Is raised if the mouseout event is raised from the ".tchmi-button-action-area" element.
                * @param event
                */
                protected __onElementMouseOut(event: EventProvider.IEventEntry): (e: MouseEvent) => void;
                /**
                * Is raised if the mouseleave event is raised from the ".tchmi-button-action-area" element.
                * @param event
                */
                protected __onElementMouseLeave(event: EventProvider.IEventEntry): (e: MouseEvent) => void;
                /**
                * Is raised if the wheel event is raised from the ".tchmi-button-action-area" element.
                * @param event
                */
                protected __onElementMouseWheel(event: EventProvider.IEventEntry): (e: MouseEvent) => void;
                /**
                * Is raised if the touchstart event is raised from  the ".tchmi-button-action-area" element.
                * @param event
                */
                protected __onElementTouchStart(event: EventProvider.IEventEntry): (e: TouchEvent) => void;
                /**
                * Is raised if the touchmove event is raised from  the ".tchmi-button-action-area" element.
                * @param event
                */
                protected __onElementTouchMove(event: EventProvider.IEventEntry): (e: TouchEvent) => void;
                /**
                * Is raised if the touchend event is raised from  the ".tchmi-button-action-area" element.
                * @param event
                */
                protected __onElementTouchEnd(event: EventProvider.IEventEntry): (e: TouchEvent) => void;
                /**
                * Is raised if the touchcancel event is raised from  the ".tchmi-button-action-area" element.
                * @param event
                */
               ...
               */
                ...
                */
                ...
                /**
                 * Shows/hides the control depending of the current 'observe' right and mark if operate is not allowed
                */
               ...
               */
                ...
                * Adds fake height when minWidth without height and only top/bottom
                */
            ...
            namespace TcHmiControl {
                ...
                interface IControlSpecificData {
                    ...
                    /** Map with style name */
                    'System.TcHmiControl.changedGetters': Map<string, boolean>;
                }
            }
        }
    }
