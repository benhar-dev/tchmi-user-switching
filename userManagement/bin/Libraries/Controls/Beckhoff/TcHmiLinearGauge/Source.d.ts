...
declare module TcHmi {
    module Controls.Beckhoff {
        class TcHmiLinearGauge extends System.TcHmiControl {
            ...
            /** Selectors */
            protected readonly __selectorTemplateRoot = ".tchmi-linear-gauge-template";
            protected readonly __selectorTrack = ".tchmi-linear-gauge-template-track";
            protected readonly __selectorFiller = ".tchmi-linear-gauge-template-filler";
            protected readonly __selectorKnob = ".tchmi-linear-gauge-template-knob";
            protected readonly __selectorLabels = ".tchmi-linear-gauge-template-labels";
            protected readonly __selectorTicks = ".tchmi-linear-gauge-template-ticks";
            protected readonly __selectorValue = ".tchmi-linear-gauge-template-value";
            protected readonly __selectorUnit = ".tchmi-linear-gauge-template-unit";
            protected readonly __selectorRange = ".tchmi-linear-gauge-template-range";
           ...
           */
            ...
            /**
            * Is called when the mousedown event is raised from the '.tchmi-linear-gauge-template-knob' element
            * @function
            * @callback
            */
            ...
            */
            ...
            /**
            * Is called when the touchstart event is raised from the '.tchmi-linear-gauge-template-knob' element
            * @function
            * @callback
            */
            ...
            */
            getValueFontSizeUnit(): "em" | "px" | "%" | "rem" | undefined;
            /**
            ...
            */
            getUnitFontSizeUnit(): "em" | "px" | "%" | "rem" | undefined;
            /**
            * Processes the current value of attribute textfontsizeunit.
            * @function
            */
