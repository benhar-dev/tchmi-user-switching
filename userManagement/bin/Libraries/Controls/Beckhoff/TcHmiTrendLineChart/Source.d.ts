...
* Version: 0.1.0.0
*
* (c) 2014 BECKHOFF Automation GmbH & Co. KG http://www.beckhoff.com
*/
    ...
    module Controls {
        module Beckhoff {
            class TcHmiTrendLineChart extends TcHmi.Controls.System.TcHmiControl {
                ...
                /** The context from the tchmi-trend-line-chart-canvas-zooming canvas */
                ...
                */
                ...
                protected __onWebSocketOpenedDestroyEvent: DestroyFunction | null;
                protected __onWebSocketErrorDestroyEvent: DestroyFunction | null;
                ...
                /** LoadingSpinner */
                protected __loadingSpinner: TcHmi.LoadingSpinner | null;
                ...
                */
                ...
                /**
                * Is raised if the onWebSocketOpened event is raised.
                * @function
                * @callback
                */
                protected __onWebSocketError(): (evt: EventProvider.Event, errorEvent: ErrorEvent) => void;
                /**
                * Is raised if the onWebSocketOpened event is raised and called the createSubscription function.
                * @function
                * @callback
                */
                protected __onWebSocketOpened(): (evt: EventProvider.Event) => void;
                /**
               ...
               */
                ...
                * @function
                */
                setXAxisFormat(xAxisNew: TcHmi.IFunction | null): void;
                /**
                ...
                */
                showOptions(): void;
                /**
                * Calculated with menuButtons added to topMostLayer
                * @function
                */
              ...
              */
                ...
                * @returns {string}
                */
                getYLabelFontSizeUnit(): "em" | "px" | "%" | "rem" | undefined;
                /**
                ...
                * @returns {string}
                */
                getXLabelFontSizeUnit(): "em" | "px" | "%" | "rem" | undefined;
                /**
                ...
                * @returns {string}
                */
                getXAxisNameFontSizeUnit(): "em" | "px" | "%" | "rem" | undefined;
                /**
               ...
               */
                ...
                */
                getMenuBarLabelFontSizeUnit(): "em" | "px" | "%" | "rem" | undefined;
                /**
                ...
                * @returns {string}
                */
                getTooltipFontSizeUnit(): "em" | "px" | "%" | "rem" | undefined;
                /**
